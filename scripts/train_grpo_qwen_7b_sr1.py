...
from trl import GRPOConfig, GRPOTrainerSR1
...
training_args = GRPOConfig(
    output_dir="results/grpo_qwen_7b_sr1",
    logging_steps=1,
    use_vllm=True,
    vllm_mode="colocate",
...
trainer = GRPOTrainerSR1(
    model="results/grpo_qwen_7b_sr1_warmup/checkpoint-800",
